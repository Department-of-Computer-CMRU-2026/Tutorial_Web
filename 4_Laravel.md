...
1. [Laravel คืออะไร](#laravel-คืออะไร)
2. [การติดตั้ง Laravel](#การติดตั้ง-laravel)
3. [โครงสร้างโฟลเดอร์โปรเจกต์](#โครงสร้างโฟลเดอร์โปรเจกต์)
4. [การทำงานของ Laravel (Request → Response)](#การทำงานของ-laravel-request--response)
5. [Routes — เส้นทาง URL](#routes--เส้นทาง-url)
6. [Controllers — จัดการ logic](#controllers--จัดการ-logic)
7. [Views — หน้าเว็บที่ผู้ใช้เห็น](#views--หน้าเว็บที่ผู้ใช้เห็น)
8. [Models และฐานข้อมูล](#models-และฐานข้อมูล)
9. [Migration — สร้าง/แก้ไขตาราง](#migration--สร้างแก้ไขตาราง)
10. [Eloquent ORM — ดึงและบันทึกข้อมูล](#eloquent-orm--ดึงและบันทึกข้อมูล)
11. [Form และ Validation](#form-และ-validation)
12. [คำสั่ง Artisan ที่ใช้บ่อย](#คำสั่ง-artisan-ที่ใช้บ่อย)
13. [สรุปแนวทางสำหรับมือใหม่](#สรุปแนวทางสำหรับมือใหม่)
...
- **PHP** (แนะนำ 8.1 ขึ้นไป) และส่วนขยายที่ Laravel ต้องการ
